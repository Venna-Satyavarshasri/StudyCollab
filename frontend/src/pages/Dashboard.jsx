...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        // Reactively update groups list when membership changes
        const onGroupJoined = (newGroup) => {
            setGroups(prev => prev.some(g => g._id === newGroup._id) ? prev : [...prev, newGroup]);
        };
    ...
    useEffect(() => { document.title = 'Dashboard – Study Planner'; }, []);

    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-8">
            <div className="w-full max-w-4xl flex justify-between items-center mb-8">
                <div className="flex items-center space-x-4">
                    <img src="/logo.svg" alt="Study Planner Logo" className="w-9 h-9" style={{filter: 'brightness(0) invert(1)'}} />
                    {user?.avatar ? (
