...
StudyCollab is a unified, real-time dashboard designed to streamline group collaboration. It replaces scattered tools (WhatsApp, Trello, Google Calendar) with a single platform where study groups can chat, plan tasks, schedule events, and share resources instantly.

### 🚀 **Live Demo:** [https://study-collab-iota.vercel.app)
...
StudyCollab uses a **Room-based Socket Architecture** to manage data flow:
...
Follow these steps to run StudyCollab locally.

### 1. Clone the Repository
```bash
git clone [(https://github.com/Venna-Satyavarshasri/StudyCollab.git)]
cd StudyCollab
```
### 2. Backend Setup
```bash
...
* LinkedIn: [View Profile](https://www.linkedin.com/in/satya-varshasri-venna/)
* GitHub: https://github.com/Venna-Satyavarshasri
